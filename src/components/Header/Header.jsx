    ...
    try {
      ...
      if (this.props.match.params.project_id) {
        ...
        const project = this.state.projects.filter(
          project => project.project_id === parseInt(this.props.match.params.project_id)
        )[0];
        if (project) {
        ...
        <div className='header-right-container'>
          ...
          <div className='header-avatar-container cursor-pointer'>
            ...
            >
              ...
              <MenuItem className='header-link' onClick={this.props.logout}>
                Logout
              </MenuItem>
            </Menu>
          </div>
        </div>
        {this.state.displayAddProjectModal && this.addProjectModal()}
      </div>
    );
  }
}
